...
@section('admin-content')
    ...
    <div class="text-end mb-3"><a class="btn btn-primary" href="{{ url('admin/data/currency-categories/create') }}"><i class="fas fa-plus"></i> Create New Currency Category</a></div>
