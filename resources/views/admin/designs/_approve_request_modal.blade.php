...
<div class="mb-3">
    ...
    <div class="d-flex">
        {!! Form::text('number', $request->character->number, ['class' => 'form-control me-2', 'id' => 'number']) !!}
...
<div class="mb-3">
    ...
    {!! Form::label('set_active', 'Set Active Image', ['class' => 'form-check-label ms-3']) !!} {!! add_help('This will set the new approved image as the character\'s masterlist image.') !!}
</div>
<div class="mb-3">
    {!! Form::checkbox('invalidate_old', 1, true, ['class' => 'form-check-input', 'data-toggle' => 'toggle']) !!}
    {!! Form::label('invalidate_old', 'Invalidate Old Image', ['class' => 'form-check-label ms-3']) !!} {!! add_help('This will mark the last image attached to the character as an invalid reference.') !!}
</div>
