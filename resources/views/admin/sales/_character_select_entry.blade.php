                ...
                <div class="character-details">
                    ...
                    @if ($sales->characters->count() > 1)
                        <div class="mb-3 text-end">
                            ...
                            {!! Form::label('character_is_open', 'Is Open', ['class' => 'form-check-label ms-3']) !!} {!! add_help('Whether or not this particular character is open or available. If the sale post itself is closed, all character sales attached will also be displayed as closed.') !!}
                        </div>
                    @else
