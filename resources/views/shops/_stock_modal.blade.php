...
@else
    <div class="text-center mb-3">
        <div class="mb-1"><a href="{{ $stock->item->idUrl }}"><img class="img-fluid" src="{{ $stock->item->imageUrl }}" alt="{{ hasAltText($stock->item, 'Main') ? getAltText($stock->item, 'Main')->alt_text : $stock->item->name }}" /></a></div>
